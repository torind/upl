...
.service('clipboardService', ['$window', function ($window) {
...
.directive('ngClickCopy', ['clipboardService', function (clipboardService) {
	return {
		restrict: 'A',
		link: function (scope, element, attrs) {
			element.bind('click', function (e) {
				clipboardService.copyToClipboard(attrs.ngClickCopy);
			});
		}
	}
}])
